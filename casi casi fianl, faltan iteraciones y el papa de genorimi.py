...
class App:
    ...
    def get_iteraciones (self):        
       self.etiqueta=tk.Label(self.window, text="¿qué número de iteraciones quiere?")
       self.etiqueta.pack()
       self.iteraciones=tk.Entry(self.window, width=20)
       self.iteraciones.pack()
       self.resultado=self.iteraciones.get()
