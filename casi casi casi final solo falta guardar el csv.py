...
class App:
    ...
    def SetContent(self):
       ...
       return self.nIteraciones#samantha
    ...
    def cargar_tablero_desde_csv(self, archivo):
        ...
        self.columnas = len(self.cuadricula[0]) #victoria
    ...
    def dibujar_cuadricula(self):
        ...
        for i in range(self.filas):
            for j in range(self.columnas):
                ...
                self.canvas.create_rectangle(x1, y1, x2, y2, fill=color, outline="#9300ff") #victoria
    ...
    def actualizar(self):
        ...
        self.dibujar_cuadricula()
        self.nIteraciones -= 1
        self.window.after(300, self.actualizar) #jeronimo
def Crear_csv(self):
    ...
    print(f"Archivo CSV guardado en: {ruta}") #jeronimo
#codigo principal
app = App()
